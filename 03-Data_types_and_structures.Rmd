...
For this course, we will limit ourselves to import data from our personal computers. Before that, go to the following link, download an excel file called `excell_iris_data.xlsx` and save to your working directory: <https://github.com/AMMHasan/Introduction-to-R-for-Biologists/blob/master/excell_iris_data.xlsx>
Download a csv version of this file from by going to this page: <https://raw.githubusercontent.com/AMMHasan/Introduction-to-R-for-Biologists/master/csv_iris_data.csv>. Right-click on the empty space on the page, select `Save As...`, then save the file to your working directory.
